<template>
    <div class="content-text text-start">
        <h1 class="font-bold text-3xl lg:text-6xl 2xl:text-8xl mb-8">Todo Mind</h1>
        <p class="font-medium text-md lg:text-lg xl:text-xl 2xl:text-2xl mb-5">
        ...
        <UButton block to="/signup" label="Get Started" color="yellow" size="xl" class="text-gray-700 hover:text-gray-100 transition-all font-semibold mb-5 lg:text-md xl:text-lg 2xl:text-xl" />
